        ...
        <div class="card" id="brand">
            ...
            <div class="card-body">
                <div class="alert alert-warning">
                    ...
                    brand icons with their setting. We will not to force them
                    to display. Please
                    <a class="alert-link" href=report an issue with Adblock Plus</a> if you believe this to be an
                        error. To work around this, youll need to modify the social icon names. </div> <div class="row text-center">
                        <div class="col-6 col-sm-4 col-md-3 col-lg-2">
