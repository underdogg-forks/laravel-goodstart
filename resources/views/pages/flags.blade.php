            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 mb-5">For using the flags inline with text add the classes
                        ...
                        <code>.flag-icon-xx</code> (where xx is the ISO 3166-1-alpha-2 code of a country) to an empty
                        span. If you want to have a squared version flag then add the class flag-icon-squared as well.</div>
